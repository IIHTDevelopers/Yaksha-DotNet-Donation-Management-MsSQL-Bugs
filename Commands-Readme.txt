...
* To connect SQL  server from terminal:
	( Project_directory/DonationManagement /sqlcmd -S localhost -U sa -P pass@word1 )
	
	-To create database from terminal - 
	1> Create Database DonationManagementDb
	2> Go
